...
/*  Created On : 14-cze-2016 22:36:38 				*/
...
IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[S這wnik_badan]') AND OBJECTPROPERTY(id, N'IsUserTable') = 1) 
DROP TABLE [S這wnik_badan]
GO
...
ALTER TABLE [Badanie_fizykalne] ADD CONSTRAINT [FK_Badanie_fizykalne_Slownik_badan]
	FOREIGN KEY ([kod]) REFERENCES [S這wnik_badan] ([kod]) ON DELETE No Action ON UPDATE No Action
GO
